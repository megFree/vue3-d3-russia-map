  ...
  <div class="region-map js-region-map">
    <svg class="region-map__svg js-map-svg">
      <g class="js-map-path-group" @mouseleave="onMapMouseLeave">
        ...
        />
        <template v-for="city in companyCities">
          <g
            :key="city"
          ...
          >
            ...
            />
            <g v-else>
              <circle r="3" class="region-map__city--big-outer js-city-bit-outer-mark" />
              <circle
                r="2.3"
                class="region-map__city--big-inner js-city-big-inner-mark"
              />
              <text class="region-map__city-counter js-company-counter">
